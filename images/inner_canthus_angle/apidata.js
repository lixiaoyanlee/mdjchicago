...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {inner_canthus_angle_info:{center_point,magnification,points,inner_canthus_angle}={},align_img} = mockData;
	...
	let data = {
		...
		fragments: {
			...
			'inner_canthus_angle_points': {
				p: pts,
			},
			// 
			'inner_canthus_angle_angle':{
				s:pts['5'],
				o:pts['4'],
				e:pts['6'],
