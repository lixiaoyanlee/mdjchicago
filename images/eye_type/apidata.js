...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {eye_type_info:{center_point,magnification,original_points_eye_type,resize_points_eye_type}={},align_img} = mockData;
	
	console.log(center_point,magnification,original_points_eye_type,'createApiData mockData')
	let pts = pointsData(resize_points_eye_type);
