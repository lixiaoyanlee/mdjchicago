...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {face_style_info:{center_point,magnification,original_points_face_style,resize_points_face_style}={},align_img} = mockData;
	
	console.log(center_point,magnification,original_points_face_style,'createApiData mockData')
	let pts = pointsData(original_points_face_style);
	...
	let data = {
		...
		fragments: {
			...
			// ...tagMapping.t_angle(apiRet),
			...tagMapping.ri_angle(pts)
		}
	};
