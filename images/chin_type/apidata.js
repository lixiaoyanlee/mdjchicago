...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {chin_type_info:{center_point,magnification,original_points_chin_type,resize_points_chin_type}={},align_img} = mockData;
	
	console.log(center_point,magnification,resize_points_chin_type,'createApiData mockData')
	let pts = pointsData(resize_points_chin_type);
