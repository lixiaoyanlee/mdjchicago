...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {face_type_info:{center_point,magnification,points}={},align_img} = mockData;
	...
	let data = {
		...
		fragments: {
			...
			'face_type_sv_1':{
				s: pts['17'],
				e: pts['18'],
				v:tagMapping.makeLength(null, face_type_info.facemid_length)
			},
			'face_type_sv_2':{
				s: pts['19'],
				e: pts['20'],
				v:tagMapping.makeLength(null, face_type_info.facedown_length)      
			},
		}
	};
