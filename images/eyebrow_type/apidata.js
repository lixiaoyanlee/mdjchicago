...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {eyebrow_type_info:{center_point,magnification,original_points_eyebrow_type}={},align_img} = mockData;
	
	console.log(center_point,magnification,original_points_eyebrow_type,'createApiData mockData')
	let pts = pointsData(original_points_eyebrow_type);
