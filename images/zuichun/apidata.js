...
const createApiData = (apiRet, divSize, _imgSize) => {
	const {lip_thickness_info:{center_point,magnification,points}={},align_img} = mockData || {};
	...
	let data = {
		...
		fragments: {
			...
			'lip_thickness_sv_v':{
				s: pts['17'],
				e: pts['18'],
				v: tagMapping.makeLength(null,lip_thickness_info.mouth_height),        
			},
			'lip_thickness_sv_h':{
				s: pts['19'],
				e: pts['20'],
				v: tagMapping.makeLength(null,lip_thickness_info.mouth_width)        
			}
		}
	};
