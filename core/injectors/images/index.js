...
const caleImage = (render, o, r = 1) => {
	console.log('caleImage 计算的点值:', render)
	if (!render) {
		return
	}
	...
	console.log('imagesInjector 计算的点值:copyImgcopyImg', copyImg)
...
const imagesInjector = (render, r, assets) => {
	console.log('imagesInjector 计算的点值:', render, r, assets)
