const yuemeiRender = require('./yuemei');

// const styleHtml =

const containerTmpl =
    '<div id="mdjYuemeiContainer" style="display:flex;flex-direction:column;position:relative;overflow:hidden;width:100%;height:100%;background:white;">' +
       
        '<div id="mdjYuemeiLottie" style="position:absolute;top:0px;"></div>' +
    '</div>';
...
const mdjYuemeiAnimation = (domObj, apiRet, callback) => {
    ...
    let lottieParams = {
        ...
        loop: true,
        autoplay: true,
        animationData: yuemeiRender(apiRet, calc.animationSize),
